...
class TransferController extends BaseController
{
    ...
    public function index()
    {
        ...
        return View::make('transfers.index')->with('title', 'All transfers')->with('transfers', $transfers);
    }
    ...
    public function add()
    {
        ...
        return View::make('transfers.add')->with('title', 'Add a transfer')->with('accounts', $accounts)->with(
            'prefilled', $prefilled
        );
    }
    ...
    public function edit(Transfer $transfer)
    {
        ...
        return View::make('transfers.edit')->with('transfer', $transfer)->with('accounts', $accounts)->with(
    ...
    public function delete(Transfer $transfer)
    {
        ...
        return View::make('transfers.delete')->with('transfer', $transfer)->with(
            'title', 'Delete transfer ' . $transfer->description
        );
    }
