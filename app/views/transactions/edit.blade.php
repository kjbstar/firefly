...
<div class="row">
    ...
    <div class="col-lg-6 col-md-6">
        ...
        <div class="form-group
            ...
            <div class="col-sm-9">
                <input type="text" name="description" class="form-control" value="{{Input::old('description') ? Input::old('description') : $transaction->description}}" id="inputDescription" placeholder="{{$transaction->description}}">
                @if($errors->has('description'))
        ...
        <div class="form-group
            ...
            <div class="col-sm-9">
                <input type="number" value="{{Input::old('amount') ? Input::old('amount') : $transaction->amount}}" name="amount" step="any" class="form-control" id="inputAmount" placeholder="&euro;">
                @if($errors->has('amount'))
